...
export const ScenarioBacklog = () => (
  <AnimatedDemo theme="light" scenario="backlog" />
)
export const ScenarioBurst = () => (
  <AnimatedDemo theme="light" scenario="burst" />
)
...
export const EduDefaults = () => (
  <AnimatedDemo theme="light" scenario="defaults" />
)
...
export const EduLowSystemCapacity = () => (
  <AnimatedDemo theme="light" scenario="low_capacity" />
)

// 9. Fully Autonomous (No human involved)
export const EduAutonomous = () => (
  <AnimatedDemo theme="light" scenario="autonomous" />
)
...
export const EduUnsupervised = () => (
  <AnimatedDemo theme="light" scenario="unsupervised" />
)
  ...
  return (
    <Frame theme={theme}>
      ...
      >
        ...
        >
          Scenario: unsupervised (monkey) | Time: {(time / 1000).toFixed(1)}s |
          Showing: {showMonkey ? "Monkey" : "Brain"}
        </div>
      </div>
    </Frame>
  )
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div>
            <h4 style={{ margin: "0 0 0.5rem 0", opacity: 0.7 }}>
              Traffic & Agent
            </h4>
            ...
            <div style={{ marginBottom: "0.5rem" }}>
              ...
              <input
                ...
                max="3000"
                step="100"
                value={agentProcessingTime}
                onChange={e => setAgentProcessingTime(parseInt(e.target.value))}
                style={{ width: "100%" }}
              />
            </div>
            ...
            <div style={{ marginBottom: "0.5rem" }}>
              ...
              <input
                ...
                onChange={e => setAutoProcessRate(parseFloat(e.target.value))}
                style={{ width: "100%" }}
              />
            </div>
            ...
            <div style={{ marginBottom: "0.5rem" }}>
              ...
              <input
                ...
                step="500"
                value={minOrbitTime}
                onChange={e => setMinOrbitTime(parseInt(e.target.value))}
                style={{ width: "100%" }}
              />
            </div>
            <div style={{ marginBottom: "0.5rem" }}>
          ...
          <div>
            ...
            <div style={{ marginBottom: "0.5rem" }}>
              ...
              <input
                ...
                max="1"
                step="0.1"
                value={returnToAgentRate}
                onChange={e => setReturnToAgentRate(parseFloat(e.target.value))}
                style={{ width: "100%" }}
              />
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            >
              <input
                type="checkbox"
                checked={enableOutage}
                onChange={e => setEnableOutage(e.target.checked)}
            ...
            <>
              <div style={{ marginBottom: "0.5rem" }}>
                ...
                <input
                  ...
                  max={itemCount}
                  step="1"
                  value={stepBackAfterItems}
                  onChange={e =>
                    setStepBackAfterItems(parseInt(e.target.value))
                  }
                  style={{ width: "100%" }}
                />
              </div>
