...
const GettingStartedPage = () => {
  ...
  const helloWorldCode =
    helloWorld?.code || "// Example not found. Run: npm run examples:ingest\n"
...
# Docker sandboxing is required by default
# Use --no-sandbox to opt out when isolation is not needed
        ...
        <div className={styles.page}>
            ...
            <div className={styles.container}>
              <div className={styles.hero}>
                ...
                <p className={styles.subtitle}>
                  The fastest way to learn Tactus is to clone the examples repo
                  and run procedures that already have embedded specifications.
                </p>
              </div>
              ...
              <div className={styles.pathGrid}>
                ...
                <div className={styles.pathCard}>
                  ...
                  <p className={styles.pathText}>
                    The best way to write, run, and debug agents. Includes a
                    visual interface for human-in-the-loop interactions and a
                    live view of agent execution.
                  </p>
                ...
                <div className={styles.pathCard}>
                  ...
                  <p className={styles.pathText}>
                    Install the CLI, clone <code>Tactus-examples</code>, then
              ...
              <div className={styles.conceptSection}>
                ...
                <p className={styles.conceptIntro}>
                  This is the canonical Hello World example from the{" "}
                  <code>Tactus-examples</code> repository. It includes an
                  embedded behavior specification so you can test it
                  deterministically in mock mode.
                </p>

                <div
                  className={styles.longCodeBlock}
                ...
                >
                  {helloWorld?.githubUrl ? (
                    <>
                      ...
                      {" · "}
                      <Link to="/examples/">
                        How to download and run examples
                      </Link>
                    </>
                  ) : (
                    <>
                ...
                <div className={styles.stepsGrid}>
                  <div className={styles.stepsCard}>
                    ...
                    <ol className={styles.stepsList}>
                      <li>
                        Download Tactus for your OS from{" "}
                        <Link to="/download/">Download</Link>.
                      </li>
                      <li>
                        Open the app — it includes example procedures ready to
                        run.
                      </li>
                      <li>
                  ...
                  <div className={styles.stepsCard}>
                    ...
                    <ol className={styles.stepsList}>
                      ...
                      <li>
                        Run for real:{" "}
                        <code>export OPENAI_API_KEY=your-key</code>, then{" "}
                        <code>
                          tactus run 01-getting-started/01-hello-world.tac
                        </code>
                      </li>
                      <li>
                        No Docker? Add <code>--no-sandbox</code> to the{" "}
                        <code>tactus run</code> command to opt out explicitly.
                      </li>
                    </ol>
                  </div>
                </div>
              ...
              <div className={styles.examplesCallout}>
                ...
                <p className={styles.examplesText}>
                  Start with the curated examples repo. Each example is designed
                  to be runnable and includes embedded behavior specifications,
                  so you can verify your environment before you spend tokens.
                </p>
              ...
              <div className={styles.projectsCallout}>
                <div className={styles.projectsHeader}>
                  ...
                  <p className={styles.examplesText}>
                    Use cases are concrete project ideas. If you want a strong
                    first build, start with an embedded copilot and add one or
                ...
                <div className={styles.projectsGrid}>
                  <div className={styles.projectsCopy}>
                    <p className={styles.projectsBody}>
                      ...
                      standard Human-in-the-Loop components. Use the IDE as a
                      safe playground to experience approvals and structured
                      inputs, then embed the same components in any application.
                    </p>
                  ...
                  <div
                    className={styles.projectsDemo}
                    aria-label="Human-in-the-loop demo"
                  >
              ...
              <div className={styles.conceptSection}>
                ...
                <p className={styles.conceptIntro}>
                  The CLI runs procedures inside a Docker sandbox by default
                  and will error if Docker is not available. This prevents
                  accidental non-isolated runs.
                </p>
                <p className={styles.conceptIntro}>
                  If your architecture does not require container isolation for
                  every invocation, opt out explicitly with{" "}
                  <code>--no-sandbox</code> or set{" "}
                  <code>sandbox.enabled: false</code> in your config.
                </p>
                <p className={styles.conceptIntro}>
                  When you install from PyPI, the sandbox image builds by
          ...
          <section className={styles.resourcesIntroSection}>
            <div className={styles.container}>
              ...
              <p className={styles.conceptIntro}>
                If you want to go deeper, the books and videos cover the ideas,
                patterns, and design philosophy behind Tactus.
              </p>
            </div>
          </section>
...
export const Head = () => (
  <Seo title="Getting Started" pathname="/getting-started/" />
)
