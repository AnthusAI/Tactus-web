          ...
          <div className={styles.container}>
            <div className={styles.hero}>
              ...
              <p className={styles.lede}>
                Tactus includes a standard library of reusable modules for
                classification, extraction, generation, and more. Each module is
                written in Tactus itself with comprehensive BDD specifications.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={`${styles.section} ${styles.bgMuted}`}>
          <div className={styles.container}>
            ...
            <p className={styles.bodyText}>
              The standard library provides high-quality, tested implementations
              for common AI workflow tasks. Each module follows the same
              patterns and can be extended for custom use cases.
            </p>
            ...
            <div className={styles.principlesList}>
              <div className={styles.principle}>
                ...
                <p className={styles.principleText}>
                  The stdlib is dogfooding - it's written in Tactus itself. This
                  ensures the language is expressive enough for real-world use
                  and surfaces any pain points.
                </p>
              </div>
              ...
              <div className={styles.principle}>
                ...
                <p className={styles.principleText}>
                  Every module has comprehensive Gherkin specifications that
                  serve as tests, documentation, and contract. If the specs
                  pass, the module works correctly.
                </p>
              </div>
              ...
              <div className={styles.principle}>
                ...
                <p className={styles.principleText}>
                  All modules use a class hierarchy. Extend BaseClassifier,
                  BaseExtractor, or BaseGenerator to create your own
