...
export const ParadigmComparison: React.FC<ParadigmComparisonProps> = ({
  ...
  const titleSpring = spring({
    ...
    fps,
    config: { damping: 120, stiffness: 200, mass: 0.8, overshootClamping: true },
  });
  ...
  const newWayBuildProgress = interpolate(sceneLocalSec, [phraseStartSec, phraseEndSec], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  const withProgress = (node: React.ReactNode, progress: number) => {
    ...
    return React.cloneElement(node as React.ReactElement<{ progress?: number }>, { progress });
  };
  ...
  return (
    <Layout>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center", opacity: animIn(sceneLocalSec - beat1) }}>
        <div
          style={{
            width: "100%",
            maxWidth: 1400,
        ...
        >
          <div style={{ width: twoColWidth, maxWidth: "100%", height: "100%", position: "relative" }}>
            <div
              style={{
                position: "absolute",
                left: "50%",
            ...
            >
              ...
              >
                ...
                >
                  <div style={{ ...labelStyle, color: colors.primary }}>The New Way</div>
                </div>
              </div>
            </div>
          </div>
