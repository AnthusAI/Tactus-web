...
;<GlobalStyles>{/* Your video content */}</GlobalStyles>
```
...
;<Container maxWidth={1200}>{/* Content */}</Container>
```
...
;<Card padding={4}>{/* Card content */}</Card>
```
...
;<CodeBlock padding={4}>{/* Code content */}</CodeBlock>
```
  ...
  return (
    <GlobalStyles>
      <Sequence from={0} durationInFrames={150}>
        <Layout>
          <H1 style={{ opacity: titleAnim }}>Welcome to Tactus</H1>
          <Body>A modern programming language designed for clarity.</Body>
          <Card>
